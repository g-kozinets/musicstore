...
public class OrdersController extends HttpServlet {
    ...
    private static String insert = "WEB-INF/NewOrdersAdd.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        //stealing delivery and instrument prices for automatic total price calculation
        DAOFactory daoFactory = new DAOFactory();

        InstrumentsDAO instrumentsDAOimpl = daoFactory.getInstrumentsDAO();
        Instruments instruments = instrumentsDAOimpl.getInstrumentById(Integer.valueOf(request.getParameter("instrFK_id")));

        SuppliersDAO suppliersDAO = daoFactory.getSuppliersDAO();
        Suppliers suppliers = suppliersDAO.getSupplierById(instruments.getSupplFK_id());

        double total_price = instruments.getPrice() + suppliers.getDelivery_price();
